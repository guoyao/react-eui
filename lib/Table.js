...
var DropdownButtonEx = function (_DropdownButton) {
    ...
    function DropdownButtonEx() {
        ...
        return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(DropdownButtonEx).apply(this, arguments));
    }
...
var TableToolBar = (_temp = _class = function (_ToolBar) {
    ...
    function TableToolBar() {
        ...
        var _this2 = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO = (0, _getPrototypeOf2.default)(TableToolBar)).call.apply(_Object$getPrototypeO, [this].concat(args)));
    ...
    (0, _createClass3.default)(TableToolBar, [{
        ...
        value: function componentDidMount() {
            (0, _get3.default)((0, _getPrototypeOf2.default)(TableToolBar.prototype), 'componentDidMount', this) && (0, _get3.default)((0, _getPrototypeOf2.default)(TableToolBar.prototype), 'componentDidMount', this).call(this);
        ...
        value: function renderCustomColumn() {
            ...
            if (this.enableCustomColumn) {
                (function () {
                    var columns = _this5.props.columns;
                    var visibleColumns = _this5.state.visibleColumns;

                    var shortcut = _this5.getShortcut(visibleColumns);
                    ...
                    if (_this5.allDefaultVisibleColumns.length > 0) {
                        defaultShortcut = _react2.default.createElement(_reactBootstrap.Input, {
                            ...
                            onChange: _this5.shortcutChangeHandler
                        });
                    }
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    { bsStyle: 'primary', onClick: _this5.submitHandler },
                                    '确定'
                                ),
                                _react2.default.createElement('span', null),
                                _react2.default.createElement(
                                    _reactBootstrap.Button,
                                    { className: 'cancel-btn', onClick: _this5.cancelHandler },
                                    '取消'
                                )
                            )
                        )
        ...
        value: function handleEditRowBtnClick() {
            ...
            var rowKeys = _table$selectedRowArg.rowKeys;
            var rows = _table$selectedRowArg.rows;
...
var Table = (_temp2 = _class2 = function (_BootstrapTable) {
    ...
    function Table() {
        ...
        var _this6 = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Table).apply(this, arguments));
    ...
    (0, _createClass3.default)(Table, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            (0, _get3.default)((0, _getPrototypeOf2.default)(Table.prototype), 'componentWillReceiveProps', this).call(this, nextProps);
        ...
        value: function compactSelectedRowArgs(rowKeys) {
            ...
            if (rowKeys && rowKeys.length) {
                (function () {
                    var key = _this7.store.getKeyField();
                    rows = _underscore2.default.filter(_this7.store.data, function (item) {
                        return _underscore2.default.contains(rowKeys, item[key]);
                    });
                    if (!_this7.props.selectCrossPage) {
        ...
        value: function componentDidMount() {
            ...
            (0, _get3.default)((0, _getPrototypeOf2.default)(Table.prototype), 'componentDidMount', this) && (0, _get3.default)((0, _getPrototypeOf2.default)(Table.prototype), 'componentDidMount', this).call(this);
            setTimeout(function () {
                _this8.initDrag();
            }, 500);
        }
        ...
        value: function initDrag(options) {
            ...
            var resizable = _props3.resizable;
