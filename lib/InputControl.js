...
var InputControl = (_temp = _class = function (_ValidatedInput) {
    ...
    function InputControl() {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (_ref = InputControl.__proto__ || (0, _getPrototypeOf2.default)(InputControl)).call.apply(_ref, [this].concat(args)));

        _this.inputHandler = function () {
            _this.maxLength && _this.forceUpdate();
        };

        var _this$props = _this.props,
            type = _this$props.type,
            showLengthTip = _this$props.showLengthTip,
        ...
        _this.state = {};
        _this.inputHandler = _underscore2.default.debounce(_this.inputHandler, 100);
        return _this;
    }
    ...
    (0, _createClass3.default)(InputControl, [{
        ...
        value: function getValue() {
            return !this.props.type ? this.props.value : (0, _get3.default)(InputControl.prototype.__proto__ || (0, _getPrototypeOf2.default)(InputControl.prototype), 'getValue', this).call(this);
        }
    }, {
        key: 'componentWillMount',
        value: function componentWillMount() {
            (0, _get3.default)(InputControl.prototype.__proto__ || (0, _getPrototypeOf2.default)(InputControl.prototype), 'componentWillMount', this) && (0, _get3.default)(InputControl.prototype.__proto__ || (0, _getPrototypeOf2.default)(InputControl.prototype), 'componentWillMount', this).call(this);
        ...
        value: function renderWrapper(children) {
            ...
            return (0, _get3.default)(InputControl.prototype.__proto__ || (0, _getPrototypeOf2.default)(InputControl.prototype), 'renderWrapper', this).call(this, children);
        }
    }, {
        key: 'renderLabel',
        ...
        value: function renderHelp() {
            ...
            return (0, _get3.default)(InputControl.prototype.__proto__ || (0, _getPrototypeOf2.default)(InputControl.prototype), 'renderHelp', this).call(this);
        }
    }, {
        key: 'renderInput',
        ...
        value: function componentDidMount() {
            (0, _get3.default)(InputControl.prototype.__proto__ || (0, _getPrototypeOf2.default)(InputControl.prototype), 'componentDidMount', this) && (0, _get3.default)(InputControl.prototype.__proto__ || (0, _getPrototypeOf2.default)(InputControl.prototype), 'componentDidMount', this).call(this);
        ...
        value: function componentWillUnmount() {
            ...
            (0, _get3.default)(InputControl.prototype.__proto__ || (0, _getPrototypeOf2.default)(InputControl.prototype), 'componentWillUnmount', this) && (0, _get3.default)(InputControl.prototype.__proto__ || (0, _getPrototypeOf2.default)(InputControl.prototype), 'componentWillUnmount', this).call(this);
    ...
    return InputControl;
}(_reactBootstrapValidation.ValidatedInput), _class.propTypes = (0, _extends3.default)({}, _reactBootstrapValidation.ValidatedInput.propTypes, {
    name: _react2.default.PropTypes.string,

    // 当有字符串长度限制时，是否展示当前已输入的字数
    showLengthTip: _react2.default.PropTypes.bool
}), _class.defaultProps = (0, _extends3.default)({}, _reactBootstrapValidation.ValidatedInput.defaultProps, {
