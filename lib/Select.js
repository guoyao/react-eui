...
var Select = (_temp = _class = function (_InputControl) {
    ...
    function Select() {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO = (0, _getPrototypeOf2.default)(Select)).call.apply(_Object$getPrototypeO, [this].concat(args)));
    ...
    (0, _createClass3.default)(Select, [{
        ...
        value: function getInputDOMNode() {
            var target = (0, _get3.default)((0, _getPrototypeOf2.default)(Select.prototype), 'getInputDOMNode', this).call(this);
        ...
        value: function componentWillReceiveProps(nextProps) {
            (0, _get3.default)((0, _getPrototypeOf2.default)(Select.prototype), 'componentWillReceiveProps', this) && (0, _get3.default)((0, _getPrototypeOf2.default)(Select.prototype), 'componentWillReceiveProps', this).call(this, nextProps);
        ...
        value: function renderControl() {
            ...
            var isRawSource = _props.isRawSource;
            var emptyLabel = _props.emptyLabel;
            var disabled = _props.disabled;
            var disableChange = _props.disableChange;
        ...
        get: function get() {
            return (0, _classnames2.default)((0, _get3.default)((0, _getPrototypeOf2.default)(Select.prototype), 'controlClassName', this), 'eui-select');
        }
    }]);
    return Select;
     ...
     */
    selectHandler: function selectHandler(value, datasource, index, selectedValues) {} }), _temp);
